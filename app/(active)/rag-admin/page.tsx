...
import { Download, Upload, Zap, FileText, Brain, RefreshCw, CheckCircle, AlertCircle, Loader2, Database, Search } from "lucide-react"
...
export default function RAGVectorizationAdmin(): ReactElement {
  ...
  const handleInsightsGeneration = async (): Promise<void> => {
    ...
    try {
      ...
      setInsightsStatus({
        type: "success",
        message: `Generated ${data.insightsCreated} new insights`,
        details: data
      })
    } catch (error) {
      setInsightsStatus({
