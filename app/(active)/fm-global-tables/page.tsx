                ...
                <Table className="min-w-[900px]">
                  <TableHeader>
                    <TableRow className="border-brand/20 bg-gradient-to-r from-brand/5 to-brand/10">
                      <TableHead className="w-32 text-brand font-semibold whitespace-nowrap h-12">Figure #</TableHead>
                      <TableHead className="min-w-[200px] text-brand font-semibold h-12">Title</TableHead>
            ...
            <Card className="overflow-hidden">
              <div className="overflow-x-auto">
                <Table className="min-w-[1000px]">
                  <TableHeader>
                    <TableRow className="border-brand/20 bg-gradient-to-r from-brand/5 to-brand/10">
                      <TableHead className="w-32 text-brand font-semibold whitespace-nowrap h-12">Table #</TableHead>
                      <TableHead className="min-w-[200px] text-brand font-semibold h-12">Title</TableHead>
                      <TableHead className="text-brand font-semibold whitespace-nowrap h-12">ASRS Type</TableHead>
